...
public class Answers {
	/**
		Question 1
			...
			- get the number of bars and store it in a Integer variable
			- print "The Cost of The Purchase is $ " + 2 * the number of bars
		Question 2
			- prompt user for the length
			- get length and store it in a Integer variable
			- prompt user for the width
			- get width and store it in a Integer variable
		...
		Question 7
			...
			- get the number and store it in a Integer variable
